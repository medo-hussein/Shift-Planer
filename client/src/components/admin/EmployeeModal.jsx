            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-3 py-2 border rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm ${errors.name ? 'border-red-300' : 'border-gray-300'
                    }`}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-3 py-2 border rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm ${errors.email ? 'border-red-300' : 'border-gray-300'
                    }`}
                  disabled={!!employee}
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="••••••••"
                    className={`w-full pl-9 pr-9 py-2 border rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm ${errors.password ? 'border-red-300' : 'border-gray-300'
                      }`}
                  />
                  <button
                    type="button"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-3 py-2 border rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm ${errors.phone ? 'border-red-300' : 'border-gray-300'
                    }`}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-3 py-2 border rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm ${errors.position ? 'border-red-300' : 'border-gray-300'
                    }`}
                />
              </div>
